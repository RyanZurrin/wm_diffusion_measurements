...
def main():
    ...
    os.system(
        f"{module_FTSM} --inputtype Fibers_File_Folder --format Column_Hierarchy --separator Comma  --inputdirectory {args.inputDirectory} --outputfile {args.outputCSV} --moreStats")
